...
from .trainer import DeepSVDDTrainer, AETrainer
from .model import Occ_Net, Occ_Net_Autoencoder
...
class DeepSVDD(object):
    ...
    def pretrain(self, dataset, optimizer_name: str = 'adam', lr: float = 0.001, n_epochs: int = 100,
        ...
        self.ae_net = Occ_Net_Autoencoder()
        self.ae_optimizer_name = optimizer_name
        self.ae_trainer = AETrainer(optimizer_name, lr=lr, n_epochs=n_epochs, lr_milestones=lr_milestones,
                                    batch_size=batch_size, weight_decay=weight_decay, device=device)
        self.ae_net = self.ae_trainer.train(dataset['train'], self.ae_net)
        self.ae_trainer.test(dataset['test'], self.ae_net)
